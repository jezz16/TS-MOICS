...
public class CloudSimulationOPSO {
      ...
      for (int cloudletIterator = 0; cloudletIterator <= cloudletLoopingNumber; cloudletIterator++) {
        ...
        for (int dataCenterIterator = 1; dataCenterIterator <= 6; dataCenterIterator++) {
          ...
          while (iteration <= 15) {
            ...
            Individual bestAntlion = Antlionpopulation.getFittest(iteration);
          ...
          for (int assigner = 0 + (dataCenterIterator - 1) * 9 + cloudletIterator * 54; assigner < 9
            ...
            outputWriter.write(Long.toString(Antlionpopulation.getFittest(dataCenterIterator).getGene(assigner % 9) % 9)); 
            outputWriter.write(" ");
          }
