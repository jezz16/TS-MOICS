...
public class CloudSimulationRR {
            ...
            for (int cloudletIterator = 0; cloudletIterator <= cloudletLoopingNumber; cloudletIterator++) {
                ...
                for (int dataCenterIterator = 1; dataCenterIterator <= 6; dataCenterIterator++) {
                    ...
                    for (int i = 0; i < cloudletList.size(); i++) {
                        ...
                        processQueue.add(new Process(i, (int) cloudlet.getCloudletLength())); // Use cloudlet length as burst time
                    }

                    // Define time quantum
                    int timeQuantum = 10; // Set your desired time quantum
                    RoundRobin roundRobin = new RoundRobin(timeQuantum);
                    roundRobin.schedule(processQueue);
...
//                       }
            ...
            Log.printLine("Cloud Simulation RR finished!");
